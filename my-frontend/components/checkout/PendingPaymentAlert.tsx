...
export default function PendingPaymentAlert() {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl border border-amber-200 bg-white/95 backdrop-blur-xl p-5 shadow-2xl shadow-amber-500/10 flex gap-4">
        {/* Pulsing indicator background gradient */}
        <div className="absolute top-0 left-0 w-2 h-full bg-amber-500" />

        {/* Icon container */}
        <div className="flex-shrink-0 mt-1">
          <div className="relative w-10 h-10 rounded-full bg-amber-50 flex items-center justify-center text-amber-500">
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white font-semibold text-xs transition duration-200 active:scale-95 shadow-sm shadow-amber-500/20"
            >
              Thanh toán ngay
            </button>
            <button
              onClick={handleDismiss}
              className="px-3 py-2 rounded-xl border border-gray-200 hover:bg-gray-50 text-gray-600 font-medium text-xs transition duration-200"
            >
              Để sau
            </button>
          </div>
