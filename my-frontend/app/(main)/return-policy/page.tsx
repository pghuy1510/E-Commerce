      ...
      <div className="max-w-7xl mx-auto px-6 py-14 space-y-14">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {policyConditions.map((item) => (
            <div
              key={item.title}
              className="bg-brand-surface border border-brand-border rounded-2xl p-5 shadow-sm">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 bg-brand-surface border border-brand-border rounded-3xl p-8 shadow-sm">
          ...
          <div className="bg-brand-surface border border-brand-border rounded-3xl p-8 shadow-sm space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-brand-text">
            ...
            <div className="flex items-start gap-3">
              <Clock3 className="w-6 h-6 text-brand-primary mt-1" />
              <div>
                <p className="font-medium text-brand-text">
            ...
            <div className="flex items-start gap-3">
              <DollarSign className="w-6 h-6 text-brand-primary mt-1" />
              <div>
                <p className="font-medium text-brand-text">
        ...
        <section className="bg-gradient-to-r from-brand-primary-light/20 to-transparent border border-brand-border rounded-3xl p-8 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <h2 className="text-xl font-bold text-brand-text">Bạn cần hỗ trợ thêm?</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 flex-shrink-0">
            <div className="bg-brand-surface border border-brand-border rounded-2xl p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-brand-text">1900 636 999</p>
              </div>
            </div>
            <div className="bg-brand-surface border border-brand-border rounded-2xl p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-brand-text font-mono">support@ecommerce.com</p>
              </div>
            </div>
            <div className="bg-brand-surface border border-brand-border rounded-2xl p-4 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-brand-text">Live chat 24/7</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* FAQ */}
        <section className="bg-brand-surface border border-brand-border rounded-3xl p-8 shadow-sm">
          <h2 className="text-2xl font-semibold text-brand-text mb-6">
            ...
            {faqItems.map((faq, index) => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left border border-brand-border rounded-2xl px-5 py-4 hover:border-brand-primary transition">
                  ...
                  {isOpen && (
                    <p className="text-sm text-brand-muted mt-3">{faq.answer}</p>
                  )}
                </button>
              );
            })}
