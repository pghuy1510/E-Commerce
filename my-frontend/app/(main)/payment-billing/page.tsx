...
export default function PaymentBillingPage() {
  ...
  return (
    <div className="w-full bg-gray-50 min-h-screen">
      {/* HERO BANNER */}
      <div className="relative overflow-hidden bg-gradient-to-r from-yellow-600 via-amber-500 to-yellow-500 py-16 text-center shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10 space-y-8">
        ...
        <section className="bg-white border border-gray-150 rounded-3xl p-6 md:p-8 shadow-sm">
          <div>
              ...
              return (
                <div
                  ...
                  className={`relative flex flex-col justify-between border rounded-2xl p-5 transition duration-300 ${
                    method.isComingSoon
                      ? "border-gray-200 bg-gray-50/70 opacity-60 cursor-not-allowed select-none"
                      : "border-gray-250 bg-white hover:border-yellow-500 hover:shadow-md cursor-default"
                  }`}
                >
                  <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {transactions.map((txn) => {
                        ...
                        return (
                          <tr key={txn.id} className="hover:bg-gray-50/55 transition-colors">
                            ...
                            <td className="py-4 text-gray-500 font-medium">{txn.createdAt}</td>
                            <td className="py-4 text-right">
                              <Link
                                href={`/orders/${orderId}`}
                                className="inline-flex items-center text-xs font-bold text-yellow-600 hover:text-yellow-700 bg-yellow-50 hover:bg-yellow-100/80 px-3 py-1.5 rounded-full transition"
                              >
                                {t("action.viewOrder")}
                              </Link>
                            </td>
                  ...
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-gray-50">
                      {refunds.map((ref) => {
                        ...
                        return (
                          <tr key={ref.refundId} className="hover:bg-gray-50/55 transition-colors">
                            <td className="py-4 font-semibold text-gray-900">
                              {ref.refundId}
                            </td>
                            <td className="py-4">
                            ...
                            <td className="py-4 text-gray-500 font-medium">{ref.createdAt}</td>
                          </tr>
                        );
                      })}
                    </tbody>
          ...
          <div className="md:col-span-1 lg:col-span-1 space-y-6">
            ...
            <section className="bg-white border border-gray-150 rounded-3xl p-6 shadow-sm">
              ...
              <div className="space-y-3.5">
                <div className="flex items-start gap-3 text-sm">
                  ...
                  <div>
                    <p className="font-semibold text-gray-800">{t("payment.status.pending")}</p>
                    <p className="text-xs text-gray-500">{t("payment.legend.pending")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <div className="w-2.5 h-2.5 rounded-full bg-green-500 mt-1.5 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-800">{t("payment.status.paid")}</p>
                    <p className="text-xs text-gray-500">{t("payment.legend.paid")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <div className="w-2.5 h-2.5 rounded-full bg-blue-500 mt-1.5 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-800">{t("payment.status.refunded")}</p>
                    <p className="text-xs text-gray-500">{t("payment.legend.refunded")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <div className="w-2.5 h-2.5 rounded-full bg-red-500 mt-1.5 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-800">{t("payment.status.failed")}</p>
                    <p className="text-xs text-gray-500">{t("payment.legend.failed")}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 text-sm">
                  <div className="w-2.5 h-2.5 rounded-full bg-gray-500 mt-1.5 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-gray-800">{t("payment.status.expired")}</p>
                    <p className="text-xs text-gray-500">{t("payment.legend.expired")}</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-white border border-gray-150 rounded-3xl p-6 shadow-sm space-y-6">
              <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3.5 p-1 hover:bg-gray-50/50 rounded-xl transition duration-200">
                  <ShieldCheck className="w-6 h-6 text-yellow-600 mt-0.5 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3.5 p-1 hover:bg-gray-50/50 rounded-xl transition duration-200">
                  <Lock className="w-6 h-6 text-yellow-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-sm text-gray-900 leading-none">
