...
import { productAPI, type BestSellerProduct } from "@/lib/api";
      ...
      {loading ? (
        <div className="flex justify-center items-center h-64">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-500">Loading best sellers...</p>
          </div>
        </div>
      ) : products.length === 0 ? (
          ...
          {products.map((product) => (
            <div
              ...
              <div className="p-5">
                ...
                <p className="text-gray-600 mt-2">Sold: {product.sold}</p>
              </div>
            </div>
          ))}
        </div>
